...
class ConfigsControllerTest < ActionController::TestCase
  ...
  test "should create config" do
    assert_difference('Config.count') do
      post :create, config: { descricao: @config.descricao, parametro: @config.parametro, valor: @config.valor }
    end
  ...
  test "should update config" do
    patch :update, id: @config, config: { descricao: @config.descricao, parametro: @config.parametro, valor: @config.valor }
    assert_redirected_to config_path(assigns(:config))
  end
